...
SAMPLE = ("https://tasks.wgu.edu/student/000000000/course/33860018"
          "/task/4521/score-report")


def test_parse_extracts_ids():
    assert ema_links.parse_ema_url(SAMPLE) == {
        "student_id": "000000000", "course_id": "33860018", "task_id": "4521"}
...
def test_build_and_roundtrip():
    url = ema_links.build_ema_url("000000000", "33860018", "4521")
    assert url == SAMPLE
