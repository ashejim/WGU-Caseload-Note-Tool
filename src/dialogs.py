...
from src.os_open import _open_in_edge, _open_externally
from src.rich_text import RichTextEditor, _HTMLToTkRenderer
...
from src.ui_common import (
    ...
    _TEMPLATE_INSERT_VARS_STUDENT, _TEMPLATE_INSERT_VARS_PM,
    _TEMPLATE_INSERT_VARS_USER,
    _build_checkbox_images, _configure_email_preview_tags,
    _fit_dialog_to_content, _restore_dialog_geometry, _save_dialog_geometry,
    font_size, register_font_box, set_font_size,
)
...
# ============================================================
# Rich-text dialogs — the HTML template editor + batch email review.
# (Use the RichTextEditor / preview widgets from src.rich_text.)
# ============================================================
